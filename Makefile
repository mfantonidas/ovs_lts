...
#am__append_10 = ovsext_make
#am__append_11 = ovsext_clean
#am__append_12 = ${PTHREAD_LIBS}
#am__append_13 = \
...
am__append_15 = -Wno-unused
am__append_16 = -Wno-unused-parameter
am__append_17 = \
	lib/dpif-netlink.c \
	lib/dpif-netlink.h \
	lib/if-notifier.c \
...
am__append_20 = lib/async-append-aio.c
#am__append_21 = lib/async-append-null.c
#am__append_22 = \
#	lib/route-table-stub.c \
#	lib/if-notifier-stub.c
...
am__append_24 = lib/stream-ssl.c
am__append_25 = lib/dhparams.c
#am__append_26 = lib/stream-nossl.c
#am__append_27 = ${PTHREAD_LIBS}
am__append_28 = \
...
#am__append_39 = tests/test-dpdkr
am__append_40 = \
...
am__append_42 = $(TESTPKI_FILES)
am__append_43 = $(TESTPKI_FILES) tests/ovs-pki.log
am__append_44 = clean-pki
am__append_45 = .h .hstamp
am__append_46 = $(HSTAMP_FILES)
am__append_47 = $(HSTAMP_FILES)
am__append_48 = vswitchd/vswitch.gv vswitchd/vswitch.pic
am__append_49 = vtep/vtep.gv vtep/vtep.pic
#am__append_50 = $(srcdir)/datapath-windows/include/OvsDpInterface.h
am__append_51 = ovn/ovn-sb.gv ovn/ovn-sb.pic
am__append_52 = ovn/ovn-nb.gv ovn/ovn-nb.pic
subdir = .
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/cmap.c lib/cmap.h lib/command-line.c lib/command-line.h \
	...
	lib/dp-packet.h lib/dp-packet.c lib/dpif-netdev.c \
	...
	lib/fatal-signal.h lib/flow.c lib/flow.h lib/geneve.h \
	lib/guarded-list.c lib/guarded-list.h lib/hash.c lib/hash.h \
	lib/hindex.c lib/hindex.h lib/hmap.c lib/hmap.h lib/hmapx.c \
	lib/hmapx.h lib/id-pool.c lib/id-pool.h lib/jhash.c \
	lib/jhash.h lib/json.c lib/json.h lib/jsonrpc.c lib/jsonrpc.h \
	lib/lacp.c lib/lacp.h lib/latch.h lib/learn.c lib/learn.h \
	lib/learning-switch.c lib/learning-switch.h lib/list.h \
	lib/lockfile.c lib/lockfile.h lib/mac-learning.c \
	lib/mac-learning.h lib/match.c lib/match.h \
	...
	lib/ofp-util.h lib/ofp-version-opt.h lib/ofp-version-opt.c \
	lib/ofpbuf.c lib/ofpbuf.h lib/ovs-atomic-c11.h \
	...
	lib/ovs-atomic.h lib/ovs-lldp.c lib/ovs-lldp.h lib/ovs-rcu.c \
	...
	lib/shash.c lib/shash.h lib/simap.c lib/simap.h lib/smap.c \
	lib/smap.h lib/socket-util.c lib/socket-util.h lib/sort.c \
	lib/sort.h lib/sset.c lib/sset.h lib/stp.c lib/stp.h \
	lib/stream-fd.c lib/stream-fd.h lib/stream-provider.h \
	...
	lib/syslog-libc.h lib/syslog-provider.h lib/table.c \
	lib/table.h lib/timer.c lib/timer.h lib/timeval.c \
	lib/timeval.h lib/tnl-neigh-cache.c lib/tnl-neigh-cache.h \
	lib/tnl-ports.c lib/tnl-ports.h lib/token-bucket.c \
	lib/tun-metadata.c lib/tun-metadata.h lib/type-props.h \
	...
	lib/vconn.c lib/vlan-bitmap.c lib/vlan-bitmap.h lib/vlandev.c \
	lib/vlandev.h lib/vlog.c lib/lldp/aa-structs.h lib/lldp/lldp.c \
	lib/lldp/lldp-const.h lib/lldp/lldp-tlv.h lib/lldp/lldpd.c \
	lib/lldp/lldpd.h lib/lldp/lldpd-structs.c \
	lib/lldp/lldpd-structs.h lib/daemon-windows.c \
	lib/getopt_long.c lib/getrusage-windows.c lib/latch-windows.c \
	lib/route-table-stub.c lib/if-notifier-stub.c lib/strsep.c \
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/classifier.lo lib/cmap.lo lib/command-line.lo \
	lib/connectivity.lo lib/coverage.lo lib/crc32c.lo lib/csum.lo \
	lib/ct-dpif.lo lib/daemon.lo lib/db-ctl-base.lo lib/dummy.lo \
	lib/dpctl.lo lib/dp-packet.lo lib/dpif-netdev.lo lib/dpif.lo \
	...
	lib/hmapx.lo lib/id-pool.lo lib/jhash.lo lib/json.lo \
	...
	lib/ofp-print.lo lib/ofp-util.lo lib/ofp-version-opt.lo \
	...
	lib/tnl-neigh-cache.lo lib/tnl-ports.lo lib/token-bucket.lo \
	lib/tun-metadata.lo lib/unicode.lo lib/unixctl.lo lib/util.lo \
	lib/uuid.lo lib/vconn-stream.lo lib/vconn.lo \
	lib/vlan-bitmap.lo lib/vlandev.lo lib/vlog.lo lib/lldp/lldp.lo \
...
am__tests_ovstest_SOURCES_DIST = tests/ovstest.c tests/ovstest.h \
	...
	tests/test-cmap.c tests/test-csum.c tests/test-flows.c \
	...
	tests/test-netlink-conntrack.c
am__objects_13 = tests/test-unix-socket.$(OBJEXT)
am__objects_14 = tests/test-netlink-conntrack.$(OBJEXT)
am_tests_ovstest_OBJECTS = tests/ovstest.$(OBJEXT) \
	...
	tests/test-classifier.$(OBJEXT) tests/test-cmap.$(OBJEXT) \
	...
	tests/test-aa.$(OBJEXT) $(am__objects_13) $(am__objects_14)
...
am__noinst_HEADERS_DIST = CONTRIBUTING.md CodingStyle.md DESIGN.md \
	...
	third-party/README.md tutorial/Tutorial.md \
	tutorial/OVN-Tutorial.md vtep/README.ovs-vtep.md NOTICE \
	.travis.yml .travis/build.sh .travis/prepare.sh appveyor.yml \
	boot.sh build-aux/cccl build-aux/cksum-schema-check \
	build-aux/dist-docs build-aux/sodepends.pl \
	build-aux/soexpand.pl build-aux/xml2nroff lib/common.man \
	...
	ovn/utilities/ovn-sbctl.8.in Vagrantfile \
	build-aux/thread-safety-blacklist \
	Documentation/group-selection-method-property.txt \
	m4/absolute-header.m4 m4/include_next.m4 lib/stdio.h.in \
	lib/string.h.in lib/dh1024.pem lib/dh2048.pem lib/dh4096.pem \
	lib/dirs.c.in lib/vswitch-idl.ann build-aux/extract-ofp-fields \
	build-aux/extract-ofp-actions build-aux/extract-ofp-errors \
	build-aux/extract-ofp-msgs ofproto/ipfix.xml \
	...
	tests/tunnel.at tests/tunnel-push-pop.at \
	tests/tunnel-push-pop-ipv6.at tests/lockfile.at \
	tests/reconnect.at tests/ovs-vswitchd.at tests/dpif-netdev.at \
	tests/dpctl.at tests/ofproto-dpif.at tests/bridge.at \
	tests/vlan-splinters.at tests/ofproto.at tests/ovsdb.at \
	...
	ovsdb/ovsdb-dot.in ovsdb/dot2pic rhel/README.RHEL \
	...
	python/README.rst python/setup.py python/ovs/__init__.py \
	python/ovs/daemon.py python/ovs/db/__init__.py \
	...
	tutorial/ovn/env1/setup.sh tutorial/ovn/env1/packet1.sh \
	tutorial/ovn/env1/packet2.sh \
	tutorial/ovn/env1/add-third-port.sh tutorial/ovn/env2/setup.sh \
	tutorial/ovn/env2/packet1.sh tutorial/ovn/env2/packet2.sh \
	tutorial/ovn/env3/setup.sh tutorial/ovn/env3/packet1.sh \
	tutorial/ovn/env3/packet2.sh tutorial/ovn/env4/setup1.sh \
	tutorial/ovn/env4/setup2.sh tutorial/ovn/env4/packet1.sh \
	tutorial/ovn/env4/packet2.sh tutorial/ovn/env4/packet3.sh \
	tutorial/ovn/env4/packet4.sh tutorial/ovn/env4/packet5.sh \
	tutorial/ovn/env5/setup.sh tutorial/ovn/env5/packet1.sh \
	tutorial/ovn/env5/packet2.sh tutorial/ovn/env6/setup.sh \
	tutorial/ovn/env6/add-acls.sh vtep/vtep-idl.ann vtep/ovs-vtep \
	vtep/vtep.ovsschema vtep/vtep.xml datapath-windows/CodingStyle \
	...
	datapath-windows/ovsext/Stt.c datapath-windows/ovsext/Stt.h \
	...
	ovn/ovn-nb.xml ovn/ovn-architecture.7.xml ovn/TODO \
	ovn/CONTAINERS.OpenStack.md ovn/OVN-GW-HA.md \
	...
	ovn/utilities/ovn-nbctl.8.xml selinux/openvswitch-custom.te \
	...
	include/windows/getopt.h include/windows/linux/pkt_sched.h \
...
ACLOCAL = ${SHELL} /home/mfantonidas/Downloads/openvswitch-2.5.0/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/mfantonidas/Downloads/openvswitch-2.5.0/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/mfantonidas/Downloads/openvswitch-2.5.0/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/mfantonidas/Downloads/openvswitch-2.5.0/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/mfantonidas/Downloads/openvswitch-2.5.0/build-aux/missing automake-1.14
AWK = gawk
CAPNG_LDADD = 
...
LT_CURRENT = 1
LT_REVISION = 0
MAKEINFO = ${SHELL} /home/mfantonidas/Downloads/openvswitch-2.5.0/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC64_LDFLAGS = 
MSVC_CFLAGS = 
...
abs_builddir = /home/mfantonidas/Downloads/openvswitch-2.5.0
abs_srcdir = /home/mfantonidas/Downloads/openvswitch-2.5.0
abs_top_builddir = /home/mfantonidas/Downloads/openvswitch-2.5.0
abs_top_srcdir = /home/mfantonidas/Downloads/openvswitch-2.5.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/mfantonidas/Downloads/openvswitch-2.5.0/build-aux/install-sh
...
ALL_LOCAL = $(am__append_6) config-h-check printf-check static-check \
	...
	$(am__append_8) $(am__append_10) $(am__append_47) \
...
CLEANFILES = $(am__append_7) $(am__append_9) manpage-dep-check \
	$(nodist_lib_libopenvswitch_la_SOURCES) lib/meta-flow.inc \
	lib/nx-match.inc lib/ofp-actions.inc1 lib/ofp-actions.inc2 \
	lib/ofp-errors.inc lib/ofp-msgs.inc ofproto/ipfix-entities.def \
	$(am__append_32) $(valgrind_wrappers) $(am__append_43) \
	include/odp-netlink.h $(am__append_46) \
	vswitchd/vswitch.ovsschema.stamp vswitchd/vswitch-idl.c \
	vswitchd/vswitch-idl.h $(OVSIDL_BUILT) \
...
CLEAN_LOCAL = clean-pycov $(am__append_11) $(am__append_44)
DISTCLEANFILES = utilities/ovs-appctl.8 utilities/ovs-ctl \
	...
	utilities/ovs-dpctl-top utilities/ovs-dpctl-top.8 \
	...
	utilities/ovs-pki.8 utilities/ovs-sim utilities/ovs-sim.1 \
	...
	$(am__append_35) tests/atconfig tests/atlocal debian/copyright \
	vswitchd/ovs-vswitchd.8 $(am__append_48) \
	vswitchd/ovs-vswitchd.conf.db.5 ovsdb/ovsdb-tool.1 \
	ovsdb/ovsdb-client.1 ovsdb/ovsdb-server.1 ovsdb/ovsdb-idlc \
	ovsdb/ovsdb-dot vtep/vtep-ctl.8 $(am__append_49) vtep/vtep.5 \
	$(am__append_51) ovn/ovn-sb.5 $(am__append_52) ovn/ovn-nb.5 \
...
docs = CONTRIBUTING.md CodingStyle.md DESIGN.md FAQ.md INSTALL.md \
	...
	INSTALL.Windows.md IntegrationGuide.md OPENFLOW-1.1+.md \
	PORTING.md README.md README-lisp.md README-native-tunneling.md \
	REPORTING-BUGS.md SECURITY.md TODO.md WHY-OVS.md \
	utilities/ovs-command-bashcomp.INSTALL.md \
	third-party/README.md tutorial/Tutorial.md \
	tutorial/OVN-Tutorial.md vtep/README.ovs-vtep.md
...
EXTRA_DIST = $(docs) NOTICE .travis.yml .travis/build.sh \
	.travis/prepare.sh appveyor.yml boot.sh build-aux/cccl \
	...
	xenserver/usr_share_openvswitch_scripts_sysconfig.template \
	python/build/__init__.py python/build/nroff.py \
	python/README.rst python/setup.py $(PYFILES) \
	python/ovs/dirs.py.template tutorial/ovs-sandbox \
	tutorial/t-setup tutorial/t-stage0 tutorial/t-stage1 \
	tutorial/t-stage2 tutorial/t-stage3 tutorial/t-stage4 \
	tutorial/ovn/env1/setup.sh tutorial/ovn/env1/packet1.sh \
...
UNINSTALL_LOCAL = $(am__append_38) ovs-uninstall-local
# ovsdb-tool.1
# ovsdb-client.1
# ovsdb-server.1
man_MANS = utilities/ovs-appctl.8 utilities/ovs-benchmark.1 \
	...
	$(am__append_33) vswitchd/ovs-vswitchd.8 \
	vswitchd/ovs-vswitchd.conf.db.5 ovsdb/ovsdb-tool.1 \
...
MAN_ROOTS = utilities/ovs-appctl.8.in utilities/ovs-benchmark.1.in \
	...
	utilities/ovs-vlan-bug-workaround.8.in utilities/ovs-test.8.in \
	utilities/ovs-vlan-test.8.in utilities/ovs-vsctl.8.in \
	$(am__append_34) vswitchd/ovs-vswitchd.8.in \
	ovsdb/ovsdb-tool.1.in ovsdb/ovsdb-client.1.in \
	ovsdb/ovsdb-server.1.in ovsdb/ovsdb-idlc.1 vtep/vtep-ctl.8.in \
...
scripts_SCRIPTS = utilities/ovs-check-dead-ifs utilities/ovs-ctl \
	utilities/ovs-save $(am__append_36) vtep/ovs-vtep \
	ovn/utilities/ovn-ctl
completion_SCRIPTS = utilities/ovs-appctl-bashcomp.bash \
	utilities/ovs-vsctl-bashcomp.bash
scripts_DATA = utilities/ovs-lib
SUFFIXES = .in .xml $(am__append_45) .ovsidl .ovsschema
check_DATA = $(am__append_42)
...
lib_libopenvswitch_la_SOURCES = lib/aes128.c lib/aes128.h \
	...
	lib/lldp/lldp-const.h lib/lldp/lldp-tlv.h lib/lldp/lldpd.c \
	lib/lldp/lldpd.h lib/lldp/lldpd-structs.c \
	lib/lldp/lldpd-structs.h $(am__append_13) $(am__append_14) \
...
nodist_lib_libopenvswitch_la_SOURCES = lib/dirs.c lib/vswitch-idl.c \
	lib/vswitch-idl.h $(am__append_25)
...
lib_libsflow_la_CFLAGS = $(AM_CFLAGS) $(am__append_15) \
	$(am__append_16)
...
ofproto_libofproto_la_LIBADD = lib/libsflow.la $(am__append_27)
...
tests_ovstest_SOURCES = tests/ovstest.c tests/ovstest.h \
	...
	tests/test-sha1.c tests/test-stp.c tests/test-util.c \
	tests/test-uuid.c tests/test-bitmap.c tests/test-vconn.c \
	tests/test-aa.c $(am__append_40) $(am__append_41)
...
$(srcdir)/manpages.mk $(srcdir)/Documentation/automake.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk $(srcdir)/datapath-windows/automake.mk $(srcdir)/datapath-windows/include/automake.mk $(srcdir)/windows/automake.mk $(srcdir)/ovn/automake.mk $(srcdir)/ovn/controller/automake.mk $(srcdir)/ovn/controller-vtep/automake.mk $(srcdir)/ovn/lib/automake.mk $(srcdir)/ovn/northd/automake.mk $(srcdir)/ovn/utilities/automake.mk $(srcdir)/selinux/automake.mk:
